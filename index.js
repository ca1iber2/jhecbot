...
client.on('message', msg => {
  ...
  //else {
    ...
    msg.channel.sendMessage("Glory be to our great lord of fire! May the everlasting flame burn for eternity and may our foes be forever vanquished by the light of our fire! Let our fire the burning the light casting the life giver look upon us and hear our thanks!")
  }
